...
import { 
  Box, Card, CardBody, FormControl, FormLabel, Input, 
  InputGroup, InputLeftAddon, Textarea, Container, Stack, Checkbox, Select 
...
export default function FormBusiness({ formData, setFormData, images, setImages, handleSubmit, isEditing }) {
